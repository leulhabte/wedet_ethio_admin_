                                    ...
                                    <TableBody>
                                        {data.map((value, index) => {
                                            ...
                                            <TableCell align="center">
                                                    <IconButton onClick={() => { const user_id = value.id; const photo = value.photoUrl.filePath; history.push({ pathname: '/photos', state: { data: user_id, photo, index: 0, ip } }) }}><Tooltip title="Photos"><Photo classes={{ root: classes.edit }}   style={{color: 'orange'}}/></Tooltip></IconButton>
                                            </TableCell>
                                        </StyledTableRow>
                                        })}
                                        <TableRow>
