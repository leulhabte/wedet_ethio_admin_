...
const EditRestaturant = ({ history }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            res.data.category.map(t => {
                t === "AUTO_REPAIR" ? setStateA({ ...stateA, checkboxA1: true }) :
                    t === "TIRES" ? setStateA({ ...stateA, checkboxA2: true }) :
                        t === "BODY_SHOPS" ? setStateA({ ...stateA, checkboxA3: true }) :
                            t === "CAR_WASH" ? setStateA({ ...stateA, checkboxA4: true }) :
                                t === "CAR_RENTAL" ? setStateB({ ...stateB, checkboxB1: true }) :
                                    setStateB({ ...stateB, checkboxB2: true })
            })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Categories
            var _categories = {
                a: stateA.checkboxA1 === true ? 'AUTO_REPAIR' : "",
                b: stateA.checkboxA2 === true ? 'TIRES' : "",
                c: stateA.checkboxA3 === true ? 'BODY_SHOPS' : "",
                d: stateA.checkboxA4 === true ? 'CAR_WASH' : "",
                e: stateB.checkboxB1 === true ? 'CAR_RENTAL' : "",
                f: stateB.checkboxB2 === true ? 'WHEEL_AND_RIM_REPAIR' : "",
            }
            ...
            if (res.status === 200) {
                ...
                setOpen2(false);
                setOpen(true);
                history.replace({ pathname: '/resList_garage' })
            }
