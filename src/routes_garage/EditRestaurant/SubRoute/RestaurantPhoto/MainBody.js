                ...
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <Box width="100%" display="flex" p={3}>
                            <Typography className={classes.tableTitle}>Garages</Typography>
                        </Box>
                                    ...
                                    <TableBody>
                                        {data.map((value, index) => {
                                            ...
                                            <TableCell align="center">
                                                    <IconButton onClick={() => { const user_id = value.id; const photo = value.photoUrl.filePath; history.push({ pathname: '/photos_garage', state: { data: user_id, photo, index: 0, ip } }) }}><Tooltip title="Photos"><Photo classes={{ root: classes.edit }}   style={{color: 'orange'}}/></Tooltip></IconButton>
                                            </TableCell>
                                        </StyledTableRow>
                                        })}
                                        <TableRow>
