...
const NewForm = ({ stateA, stateB, handleChangeA, handleChangeB,
    name, description, address, phone, about,
                ...
                <Box width="100%" display="flex" flexDirection="column">
                    <Grid container spacing={4}>
                        <Grid item md={6} xs={10}>
                            <FormSection
                                setDescription={setDescription} setAddress={setAddress} setPhoneNum={setPhoneNum} setAboutUs={setAboutUs} phone={phone} address={address}
