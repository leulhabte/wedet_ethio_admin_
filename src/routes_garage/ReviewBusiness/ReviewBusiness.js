...
const ReviewBusiness = ({history}) => {
    ...
    return (
        <Container>
            ...
            {error && <Box display="flex" justifyContent="center" alignItems="center" width="100%" py={30}><Button  className={classes.btn2} onClick={()=>{history.push({pathname: '/gRoute', state: {path: 'resList_garage', data: null}})}}>Retry</Button></Box>}
        </Container>
    )
}
