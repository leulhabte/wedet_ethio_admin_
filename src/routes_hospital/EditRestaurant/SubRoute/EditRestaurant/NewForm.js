...
const NewForm = ({ stateA, stateB, stateC, handleChangeA, handleChangeB, handleChangeC, name, description, address, phone, about,
                ...
                <Box width="100%" display="flex" flexDirection="column">
                    ...
                    <Paper className={classes.paperPad}>
                        <Checkboxes
                            ...
                            handleChangeA={handleChangeA} handleChangeB={handleChangeB} handleChangeC={handleChangeC} address={address} phone={phone}
                        />
                    </Paper>
                </Box>
