                                                ...
                                                return <StyledTableRow key={k}>
                                                        ...
                                                        <TableCell align="center">
                                                            <Box display='flex' flexDirection='row' justifyContent="center">
                                                                <IconButton onClick={() => { const user_id = v.id; history.push({ pathname: '/editRes_hotel', state: { data: user_id } }) }}><Tooltip title="Edit"><Edit classes={{ root: classes.edit }} style={{color: 'blue'}} /></Tooltip></IconButton>
